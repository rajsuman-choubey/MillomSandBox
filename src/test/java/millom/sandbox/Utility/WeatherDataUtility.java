...
import millom.sandbox.pojo.Descriptions;
import millom.sandbox.pojo.Sol;
...
public class WeatherDataUtility {
  ...
  public static final NasaWeather WEATHER_DATA = new NasaWeather.NasaWeatherBuilder().sols(SOLS).descriptions(DESCRIPTIONS).build();
}