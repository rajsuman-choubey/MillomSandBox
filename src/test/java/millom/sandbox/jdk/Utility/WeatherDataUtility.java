...
import millom.sandbox.jdk.record.Descriptions;
import millom.sandbox.jdk.record.NasaWeather;
import millom.sandbox.jdk.record.Sol;
...
public class WeatherDataUtility {
  ...
  private static final Sol SOL1 = new Sol.Builder("3341").terrestrialDate("2022-07-01")
      .sol("3520")
  ...
  private static final Sol SOL2 = new Sol.Builder("3344").terrestrialDate("2022-07-02")
      .sol("3521")
